...
import com.netease.nim.demo.main.activity.WebViewActivity;
...
public class LoginActivity extends UI implements OnKeyListener {
    ...
    private void setupLoginPanel() {
        ...
        //loginAccountEdit.setText("6c578fa5cdb7e22609c16008bc2b8d32");
        //loginPasswordEdit.setText("238a8cb9657ef6e844d5a9e84579fe49");
    }
    ...
    private void login() {
        ...
        loginRequest = NimUIKit.login(new LoginInfo(account, token), new RequestCallback<LoginInfo>() {
            ...
            public void onSuccess(LoginInfo param) {
                ...
                WebViewActivity.start(LoginActivity.this, "http://192.168.23.87:8183/webdemo/im/login.html");
